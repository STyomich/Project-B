  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen bg-gray-50 p-6 ">
      ...
      <div className="flex flex-wrap gap-6 mt-6">
        {filterParams === "Live" && <LiveAuctions searchByNameParams={searchByNameParams} />}
        {filterParams === "Upcoming" && <UpcomingAuctions searchByNameParams={searchByNameParams} />}
        {filterParams === "Deprecated" && <DeprecatedAuctions searchByNameParams={searchByNameParams} />}
      </div>
    </div>
  );
}
